...
namespace Lab._11
{
    public partial class Kitsune : Form
    {
        int i = 0;
        public Kitsune()
        {
        ...
        {
            MessageBox.Show("Web-браузер розробив студент гр. IPZ-42  Поліщук Сергій Віталійович e-mail super-serg.p@ukr.net", "info", MessageBoxButtons.OKCancel, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
        }
